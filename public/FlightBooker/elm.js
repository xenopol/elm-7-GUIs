...
var author$project$Main$SetDepartureDay = function (a) {
	return {$: 3, a: a};
};
var author$project$Main$SetReturnDay = function (a) {
	return {$: 4, a: a};
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Events$onInput(author$project$Main$SelectFlightType)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$value('one-way')
								]),
							_List_fromArray(
								[
									elm$html$Html$text('one-way flight')
								])),
							A2(
							elm$html$Html$option,
							_List_fromArray(
								[
									elm$html$Html$Attributes$value('return')
								]),
							_List_fromArray(
								[
									elm$html$Html$text('return flight')
								]))
						])),
					A2(
					elm$html$Html$input,

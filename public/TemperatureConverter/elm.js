...
var author$project$Main$convertCToF = function (temp) {
	return A2(
		elm$core$Maybe$map,
		function (n) {
			return ((n * 9) / 5) + 32;
		},
		elm$core$String$toFloat(temp));
};
var elm$core$Basics$sub = _Basics_sub;
var author$project$Main$convertFToC = function (temp) {
	return A2(
		elm$core$Maybe$map,
		function (n) {
			return ((n - 32) * 5) / 9;
...
var author$project$Main$getTempWithDefault = F2(
	function (_default, temp) {
		return A2(
		...
		if (!msg.$) {
			...
			return _Utils_update(
				model,
				{
					z: value,
					A: A2(
						author$project$Main$getTempWithDefault,
						model.A,
						author$project$Main$convertCToF(value))
				});
		} else {
			var value = msg.a;
			return _Utils_update(
				model,
				{
					z: A2(
						author$project$Main$getTempWithDefault,
						model.z,
						author$project$Main$convertFToC(value)),
					A: value
				});
		}
	});
var author$project$Main$ConvertCelsius = function (a) {
	return {$: 0, a: a};
};
var author$project$Main$ConvertFahrenheit = function (a) {
	return {$: 1, a: a};
};
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onInput(author$project$Main$ConvertCelsius),
								elm$html$Html$Attributes$value(celsius)
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$type_('text'),
								elm$html$Html$Events$onInput(author$project$Main$ConvertFahrenheit),
								elm$html$Html$Attributes$value(fahrenheit)
							]),
						_List_Nil)
					]))
			]));

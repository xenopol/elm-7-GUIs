...
var author$project$Main$Model = F2(
	function (timer, range) {
		return {G: range, w: timer};
	});
var author$project$Main$timerMaxValue = 30;
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		A2(author$project$Main$Model, 0, author$project$Main$timerMaxValue / 2),
...
var author$project$Main$subscriptions = function (_n0) {
	var timer = _n0.w;
	var range = _n0.G;
	return (_Utils_cmp(timer, range) < 0) ? A2(elm$time$Time$every, 100, author$project$Main$Tick) : elm$core$Platform$Sub$none;
};
			...
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							w: elm$core$Basics$round(10 * (0.1 + model.w)) / 10
						}),
					elm$core$Platform$Cmd$none);
			case 1:
				var value = msg.a;
...
var author$project$Main$SetTimerRange = function (a) {
	return {$: 1, a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Flight Booker')
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text('Elapsed Time:'),
						A2(
						elm$html$Html$progress,
						_List_fromArray(
							[
								elm$html$Html$Attributes$max(
								elm$core$String$fromFloat(range)),
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$max(
								elm$core$String$fromInt(author$project$Main$timerMaxValue)),
								elm$html$Html$Attributes$value(
								elm$core$String$fromFloat(range)),
								elm$html$Html$Events$onInput(author$project$Main$SetTimerRange)
							]),
						_List_Nil)
					])),
				A2(
